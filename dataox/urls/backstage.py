...
urlpatterns = patterns('',
    ...
    url(r'^account/webauth/$', django_webauth.views.LoginView.as_view(), name='webauth_login'),
    url(r"^account/logout/$", django_webauth.views.LogoutView.as_view(), name="webauth_logout"),
